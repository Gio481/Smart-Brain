...
import com.example.smartbrainguessmovies.presentation.start.completion.di.SBStartGuessMoviesCompletionModule
...
class SBStartGuessMoviesFeatureComponentImpl : SBStartGuessMoviesFeatureComponent {
    ...
    override fun completionModule() = SBStartGuessMoviesCompletionModule(featureQualifier())
