...
sealed class SBAnimation(val transition: Transition?, val duration: Long) {
    init {
    ...
    companion object {
        ...
        fun leftToRight(duration: Long = DEFAULT_ANIMATION_DURATION) = Slide(Gravity.LEFT, duration)
