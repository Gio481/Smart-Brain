...
class ViewPagerCircleIndicator @JvmOverloads constructor(
    context: Context,
    attrs: AttributeSet,
    defStyle: Int = 0,
    ...
    init {
        val typedArray = context.obtainStyledAttributes(attrs, R.styleable.ViewPagerCircleIndicator, defStyle, 0)
        indicatorMargin = typedArray.getDimensionPixelSize(R.styleable.ViewPagerCircleIndicator_circleIndicatorMargin, DEFAULT_INDEX)
        activeIndicator = typedArray.getResourceId(R.styleable.ViewPagerCircleIndicator_activeCircleBackground, DEFAULT_INDEX)
        inactiveIndicator = typedArray.getResourceId(R.styleable.ViewPagerCircleIndicator_inactiveCircleBackground, DEFAULT_INDEX)
        circleIndicatorSize = typedArray.getDimensionPixelSize(R.styleable.ViewPagerCircleIndicator_circleIndicatorSize, DEFAULT_INDEX)
        typedArray.recycle()
    }
